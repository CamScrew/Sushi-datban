...
export default function RegisterPage() {
  ...
  const validate = () => {
    ...
    if (!data.password) {
      ...
      newErr.password = "Mật khẩu không hớp";
    }
    if (!data.name) {
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-start mb-6">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="terms" className="text-[#594545]">
                    Tôi đồng ý với{" "}
                    <a
                      href="#"
                      className="text-[#9E7676] hover:text-[#815B5B] underline"
                    >
                      Điều khoản dịch vụ
                    </a>{" "}
                    và{" "}
              ...
              <div className="flex items-start mb-6">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="newsletter" className="text-[#594545]">
