      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-[#9E7676] mt-2">Đăng nhập để đặt bàn và theo dõi thẻ thành viên của bạn</p>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-1">
                  <label htmlFor="password" className="block text-sm font-medium text-[#594545]">
                    Mật khẩu
                  </label>
                  <a href="/forgot" className="text-sm text-[#9E7676] hover:text-[#815B5B]">
                    Quên mật khẩu?
                  </a>
                </div>
                <input
              ...
              <div className="flex items-center mb-6">
                ...
                />
                <label htmlFor="remember" className="ml-2 block text-sm text-[#594545]">
                  Ghi nhớ đăng nhập
                </label>
              </div>
          ...
          <div className="text-center mt-6">
            <p className="text-[#594545]">
              Chưa có tài khoản?{" "}
              <a href="/register" className="text-[#9E7676] font-medium hover:text-[#815B5B]">
                Đăng ký ngay
              </a>
            </p>
          </div>
