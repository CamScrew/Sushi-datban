      ...
      <div className="min-h-screen bg-[#FFF9F0]">
        ...
        <section className="py-12 px-4 bg-[#FFF9F0]">
          <div className="container mx-auto text-center max-w-3xl">
            ...
            <p className="text-[#9E7676] mb-6">
              Hãy đặt trước để đảm bảo bạn có một chỗ ngồi tại nhà hàng của chúng tôi. Chúng tôi mong muốn được phục vụ
              bạn những trải nghiệm ẩm thực Nhật Bản tuyệt vời nhất.
            </p>
        ...
        <section className="py-8 px-4 bg-[#FFF9F0]">
          <div className="container mx-auto flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-2/3 bg-white rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-semibold text-[#594545] mb-6">Thông tin đặt bàn</h2>
  
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-[#594545] mb-1">
                      Họ và tên
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-sm font-medium text-[#594545] mb-1">
                      Số điện thoại
                    </label>
                    <input
                      type="tel"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-[#594545] mb-1">
                      Email
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label htmlFor="guests" className="block text-sm font-medium text-[#594545] mb-1">
                      Số lượng khách
                    </label>
                    <select
                      id="guests"
                    ...
                    >
                      ...
                      <option value="more">Hơn 8 người</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="date" className="block text-sm font-medium text-[#594545] mb-1">
                      Ngày
                    </label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label htmlFor="time" className="block text-sm font-medium text-[#594545] mb-1">
                      Thời gian
                    </label>
                    <select
                      id="time"
                ...
                <div>
                  <label htmlFor="request" className="block text-sm font-medium text-[#594545] mb-1">
                    Yêu cầu đặc biệt
                  </label>
                  <textarea
                    id="message"
            ...
            <div className="lg:w-1/3 space-y-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-semibold text-[#594545] mb-4">Giờ mở cửa</h3>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-semibold text-[#594545] mb-4">Chính sách đặt bàn</h3>
              ...
              <div className="bg-[#FFF3E4] rounded-lg shadow-md p-6">
                <h3 className="text-xl font-semibold text-[#594545] mb-4">Liên hệ</h3>
        ...
        <section className="py-12 px-4 bg-[#FFF3E4]">
          <div className="container mx-auto text-center max-w-4xl">
            <h2 className="text-2xl font-bold text-[#594545] mb-6">Khung giờ phổ biến</h2>
            <p className="text-[#9E7676] mb-8">
              Dưới đây là các khung giờ phổ biến mà khách hàng thường đặt bàn. Bạn có thể chọn thời gian phù hợp với lịch
              trình của mình.
            </p>
  
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {["11:30", "12:00", "12:30", "13:00", "17:30", "18:00", "19:00", "20:00"].map((time) => (
                <div
                  key={time}
